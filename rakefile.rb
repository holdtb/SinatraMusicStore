...
def load_customers
		parse_key("Customer") do |item|
    		Customer.create!(:original_id => item.CustomerId.to_i,
...
def associate
  ...
  puts "Tracks have been successfully mapped to their Album."
end
